...
export default function Auth() {
  ...
  async function fetchBalances(accounts: AccountData[]) {
    ...
    console.log("balance", newBalances, balances);
  }
  ...
  function loadAccounts(): AccountData[] {
    const dataRaw =
      typeof window !== "undefined" && sessionStorage.getItem(accountDataKey);
    if (!dataRaw) {
      return [];
    }
    ...
    <div className='min-h-screen flex '>
      ...
      <div className='bg-secondary flex justify-end pb-10 items-center flex-col w-full'>
        {current_auth_component_login ? (
          <Login begin={beginZkLogin} changeAuth={toggleAuthComponent} />
        ) : (
          <Register begin={beginZkLogin} changeAuth={toggleAuthComponent} />
        )}
      </div>
                ...
                <div className='account' key={acct.userAddr}>
                  ...
                  {balance === 0 && (
                    <button
                      ...
                      onClick={() => {
                        requestSuiFromFaucet("devnet", acct.userAddr);
                        setModalContent(
